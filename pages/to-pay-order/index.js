...
Page({
  ...
  onShow: function () {
    var that = this;
    var shopList = [];
    let list = wx.getStorageSync('AccountList')
  ...
  createOrder: function (e) {
    console.log(e)
    let wechatOrderId = '1234567890'
    let data = `orderId=${this.data.orderId}&wechatOrderId=${wechatOrderId}`
    api.playorder(data).then(res => console.log(res))
    /*
    console.log(e)
    // wx.showLoading();
    var that = this;
  ...
  processYunfei: function () {
    // this.setData({
    //   curAddressData: wx.getStorageSync('curAddressData')
    // });
    // console.log(wx.getStorageSync('curAddressData'))
    /*
    var that = this;
